...
module.exports = React.createClass({displayName: 'exports',
        ...
        button(
          {
            ...
            'aria-title': this.props.ariaTitle,
  ...
  renderOption: function (option, i) {
    ...
    return a(
      ...
      option.label,
      option.tag && this.renderOptionSpan(option)
    )
  },

  renderOptionSpan: function (option) {
    return span(
      {
        className: 'react-select-box-badge'
      },
      option.tag
    );
  },
